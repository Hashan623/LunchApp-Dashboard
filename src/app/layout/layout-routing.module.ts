...
const routes: Routes = [
    {
        ...
        children: [
           ...
           { path: 'outlets-form/:id', loadChildren: './outlets/outlets-form/outlets-form.module#OutletsFormModule' },
            ...
            { path: 'orders-form/:id', loadChildren: './orders/orders-form/orders-form.module#OrdersFormModule' },
            ...
            { path: 'users-form/:id', loadChildren: './users/users-form/users-form.module#UsersFormModule' },
            ...
            { path: 'user-levels-form/:id', loadChildren: './user-levels/user-levels-form/user-levels-form.module#UserLevelsFormModule' },
            ...
            { path: 'components-list-form/:id', loadChildren: './components-list/components-list-form/components-list-form.module#ComponentsListFormModule' },
            ...
            { path: 'set-permissions/:id', loadChildren: './user-level-permission/user-level-permission.module#UserLevelPermissionModule' }
